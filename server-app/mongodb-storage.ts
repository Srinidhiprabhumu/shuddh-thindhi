    ...
    if (contentCount === 0) {
      const brandContentData: BrandContent[] = [
        ...
        },
        {
          ...
          section: "story",
          title: "The Beginning",
          content: "The journey of Shuddha Thindi began with a powerful, personal experience. Our 16-year-old founder's simple desire for a local thekua turned into a harsh lesson on food hygiene. This single incident sparked a powerful question: Why can't traditional snacks be both delicious and safe?\n\nThis was followed by another realization during Chhath Puja—the best snacks were scarce and seasonal. This scarcity and lack of hygiene wasn't just a problem; it was an opportunity to create something better.",
        },
        {
          id: "content-values",
          section: "values",
          title: "Our Core Values",
          content: "Sustainability: At Shuddha Thindi, sustainability is a part of our promise to serve food that is good for people and the planet. We follow mindful practices to reduce waste, use eco-friendly packaging wherever possible, and source ingredients responsibly from local suppliers.\n\nHealth: At Shuddha Thindi, we believe that tasty food should also be healthy and safe for your family. Our snacks are prepared using clean, fresh ingredients without preservatives, artificial colours, or harmful additives. Every batch is made in a hygienic environment, with a focus on balanced flavours that suit all age groups. By choosing traditional preparation methods over processed shortcuts, we ensure that every bite is wholesome, trustworthy, and gentle on your health.\n\nQuality: Quality is at the heart of everything we do at Shuddha Thindi. We prepare our snacks using fresh, carefully selected ingredients and follow strict hygiene standards to ensure purity in every batch. Each product is made in small quantities to maintain consistent taste, freshness, and authenticity. With no artificial flavours, colours, or preservatives, we deliver honest, home-style quality you can trust with every bite.\n\nCommunity: At Shuddha Thindi, we believe food brings people together, and we are committed to nurturing a strong community through our work. We support local families, home-based cooks, and small suppliers by sourcing ingredients and talent from within our community. Our goal is to create opportunities, encourage traditional culinary skills, and promote a culture of sharing, togetherness, and mutual growth. We strive to build a community where purity, tradition, and goodwill are celebrated with every snack we serve.",
        },
      ];
